...
impl ConfirmDialog {
    ...
    pub fn render(&self, frame: &mut Frame, area: Rect) {
        ...
        let (border_color, title_prefix) = match pending.check {
            ToolExecutionCheck::RequiresConfirmation => (Color::Yellow, "⚠ CONFIRM"),
            ToolExecutionCheck::RequiresDangerousMode => (Color::Red, "🚫 BLOCKED"),
            ToolExecutionCheck::PathNotAllowed => (Color::Red, "🚫 PATH DENIED"),
            ToolExecutionCheck::UnknownTool => (Color::Red, "❓ UNKNOWN"),
            ToolExecutionCheck::Allowed => (Color::Green, "✓ ALLOWED"),
        };
        ...
        let tool_line = Line::from(vec![
            ...
            Span::styled(pending.tool_name(), Style::default().fg(Color::White).add_modifier(Modifier::BOLD)),
        ]);
